...
#  R_LIBRARY_GRAPHAPP  - Path to Rgraphapp library
...
#  R_LIBS_USER         - Path to user's personal library directory.
#
...
if(R_COMMAND)
  ...
  execute_process(WORKING_DIRECTORY .
                  COMMAND "Rscript" "-e" "cat(path.expand(Sys.getenv(\"R_LIBS_USER\")))"
		  OUTPUT_VARIABLE R_LIBS_USER
		  OUTPUT_STRIP_TRAILING_WHITESPACE)
# deprecated
  if(VTK_R_HOME)
  ...
  find_path(R_INCLUDE_DIR R.h
            ...
            PATH_SUFFIXES include R/include src/gnuwin32/fixed/h
  ...
  find_library(R_LIBRARY_GRAPHAPP Rgraphapp
            HINTS ${R_ROOT_DIR}/lib
            DOC "R library (example libR.a, libR.dylib, etc.).")
...
set(R_LIBRARIES ${R_LIBRARY_BASE} ${R_LIBRARY_GRAPHAPP} ${R_LIBRARY_BLAS} ${R_LIBRARY_LAPACK} ${R_LIBRARY_BASE})
